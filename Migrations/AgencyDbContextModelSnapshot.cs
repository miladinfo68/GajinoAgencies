            ...
            modelBuilder.Entity("GajinoAgencies.Models.Location", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "تهران",
                            CityCode = "THR",
                            CreationDate = new DateTime(2024, 9, 8, 15, 45, 30, 964, DateTimeKind.Local).AddTicks(8130),
                            IsActive = true,
                            Province = "تهران"
                        },
                        new
                        {
                            ...
                            City = "همدان",
                            CityCode = "HMD",
                            CreationDate = new DateTime(2024, 9, 8, 15, 45, 30, 964, DateTimeKind.Local).AddTicks(8140),
                            IsActive = true,
                            Province = "همدان"
                        },
                        new
                        {
                            ...
                            City = "شیراز",
                            CityCode = "SHZ",
                            CreationDate = new DateTime(2024, 9, 8, 15, 45, 30, 964, DateTimeKind.Local).AddTicks(8141),
                            IsActive = true,
                            Province = "شیراز"
                        },
                        new
                        {
                            ...
                            City = "اصفهان",
                            CityCode = "ESF",
                            CreationDate = new DateTime(2024, 9, 8, 15, 45, 30, 964, DateTimeKind.Local).AddTicks(8142),
                            IsActive = true,
                            Province = "اصفهان"
                        },
                        new
                        {
                            ...
                            City = "یزد",
                            CityCode = "YZD",
                            CreationDate = new DateTime(2024, 9, 8, 15, 45, 30, 964, DateTimeKind.Local).AddTicks(8143),
                            IsActive = true,
                            Province = "یزد"
                        },
                        new
                        {
                            ...
                            City = "لرستان",
                            CityCode = "LOR",
                            CreationDate = new DateTime(2024, 9, 8, 15, 45, 30, 964, DateTimeKind.Local).AddTicks(8145),
                            IsActive = true,
                            Province = "لرستان"
                        },
                        new
                        {
                            ...
                            City = "کرج",
                            CityCode = "KRJ",
                            CreationDate = new DateTime(2024, 9, 8, 15, 45, 30, 964, DateTimeKind.Local).AddTicks(8146),
                            IsActive = true,
                            Province = "کرج"
                        });
                });
